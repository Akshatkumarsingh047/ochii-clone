...
export const Footer = () => {
  return (
    <div className="bg-zinc-800 fonts w-full flex gap-20 h-full p-20">
      <div className="w-1/2 h-full fonts flex flex-col justify-between">
      ...
      <div className="w-1/2">
        <h1 className="text-[5vw] leading-none -mb-10 uppercase font-semibold">
          presentations
        </h1>
        <div className="details flex font-['Neue Montreal'] flex-col gap-5 mt-20 text-zinc-600">
