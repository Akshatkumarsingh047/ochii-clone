...
export const Navbar = () => {
  ...
  return (
    <div
      className={`w-full fixed z-[999] px-20  py-8 font-['Neue_Montreal'] font-md flex justify-between cursor-pointer ${
        nav ? "hidden" : "block"
      }`}
    >
      ...
      <div className="links flex gap-10">
        {["Services", "Our Work", "About Us", "Insights", "contact"].map(
          (item, index) => (
            <a
              key={index}
              className={`text-lg text-white capitalize  font-regular ${
                index === 4 && "ml-20"
              }`}
            >
              {item}
